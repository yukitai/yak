...
type Statement = BadNode | ExprStatement | IfStatement | WhileStatement | ForInStatement | ReturnStatement
...
type Type = BadNode | BuiltinType | ArrayType | GenericType | UnsizedType | NameType | InferType
