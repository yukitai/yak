import { GRAY, CLEAR, CYAN, LIGHT, BOLD, ITALLIC, MAGENTA, UNDERLINE, GREEN } from "../src/error/colors.ts";
...
class Formatter {
    ...
    get_indent () {
        if (this.indent_count > 0) {
            return this.leading_indent.repeat(this.indent_count - 1) + this.last_indent
        } else {
            return ""
        }
    }
